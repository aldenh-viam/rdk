...
func New(
	...
	if err := svc.TBD_InternalReconfigure(ctx, deps, conf); err != nil {
		return nil, err
	}
	return svc, nil
}
...
func (b *builtIn) TBD_InternalReconfigure(ctx context.Context, deps resource.Dependencies, conf resource.Config) error {
